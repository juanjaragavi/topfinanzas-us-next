...
export interface SharedCreditCardRecommenderProps {
  logTag: string;
  stepQuestion: string;
  stepSubtitle: string;
  nextRoute: string;
  variant?: "glassmorphism" | "3d-blue" | "default" | "quest";
}

export default function SharedCreditCardRecommender({
  logTag,
  stepQuestion,
  stepSubtitle,
  nextRoute,
  ...
  const handleSelect = useCallback(
    (optionId: string) => {
      ...
      formLogger.info(`[${logTag}] Step completed`, {
        step: 10,
        selection: optionId,
        ...
        <main className="relative flex-grow flex flex-col">
          <div className="max-w-3xl mx-auto w-full px-4 py-2 md:py-6 flex-grow flex flex-col">
            <div className="flex justify-center mb-3 md:mb-4">
              <AdSlot unitIndex={1} logTag={logTag} />
            </div>
            ...
            <motion.div
              id="invit-credit-card-rec-us-10-preguntas-2"
