...
export function MessageBubble({
  ...
  return (
    ...
    >
      <div
        className={`flex gap-2 max-w-[85%] md:max-w-md ${isBot ? "flex-row" : "flex-row-reverse"}`}
      >
        {isBot && (
          ...
          >
            {type === "typing" ? (
              ...
              <>
                ...
                {timestamp && (
                  <div
                    className={`text-[10px] mt-1 text-right ${isBot ? "text-gray-400" : userTextTail}`}
                  >
                    {timestamp}
                  </div>
                )}
            ...
            {isBot ? (
              <svg
                ...
                className="absolute bottom-0 -left-2 w-4 h-4 text-white fill-current"
              >
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className={`absolute bottom-0 -right-2 w-4 h-4 ${userTextTail.replace("text-", "text-").replace("100", "500")} fill-current`}
                style={{
                  transform: "scaleX(-1)",
                  color: theme === "green" ? "#10B981" : "#3B82F6",
                }}
              >
                <path d="M41.6 43.5C41.6 43.5 29.8 41.2 21.3 32C12.8 22.8 15.5 0 15.5 0H0C0 0 1.2 24.5 13.5 35.8C25.8 47.1 41.6 43.5 41.6 43.5Z" />
              </svg>
