...
- You should also define how these ad units will be named. All ad units of the website should start with the same prefix, to make it easier for report pulling. For TopFinanzas US, for example, we used the TOPFIN_US prefix.
...
topAds.config \= {  
 ...
 networkCode: 'YOUR_NETWORK_CODE', // Add the newtork code from GAM  
 lazyLoad: 'soft',  
 pageSetting: {  
 exclude: \[  
 '/page-1',  
