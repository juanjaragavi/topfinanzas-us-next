...
const LOG_TAG = "CC-REC-6";
const STEP_QUESTION = "What's your credit score range?";
const STEP_SUBTITLE =
  "This helps us match cards you're most likely to be approved for.";

export default function InvitCreditCardRecUS6Page() {
  const offerwallQuiz = FINANCE_QUIZ_CONFIGS.creditCardRecommender6;
  ...
  const handleSelect = useCallback(
    (optionId: string) => {
      ...
      advanceTimerRef.current = setTimeout(() => {
        window.scrollTo(0, 0);
        router.push("/invit-credit-card-rec-us-7");
      }, 350);
    },
    [router],
  );
