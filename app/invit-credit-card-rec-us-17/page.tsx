...
const FunnelStep17: React.FC = () => {
  ...
  const handleRedirect = () => {
    ...
    const exitUrl =
      funnelState.primaryGoal === "travel"
      ...
      >
        ...
        >
          ...
          >
            <div className="bg-gradient-to-br from-green-50 to-green-100 h-40 w-full flex flex-col items-center justify-center rounded-xl border-4 border-green-400 shadow-inner">
              ...
              <span className="text-green-800 text-xl font-black uppercase tracking-widest drop-shadow-sm">
                Match Found!
              </span>
            </div>
          </ScratchCard>
        ...
        <motion.div variants={itemVariants}>
          <Button
            ...
            className={
              !scratched ? "opacity-50 grayscale" : "animate-pulse shadow-xl"
            }
          >
            {scratched ? "✨ Claim Your Card Now!" : "Scratch Above to Unlock!"}
          </Button>
          <p className="text-sm text-gray-500 px-4 mt-4 font-medium">
            Your answers have led to this exclusive match tailored to your
            goals.
          </p>
        </motion.div>
      </motion.div>
