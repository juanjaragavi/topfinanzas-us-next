...
export default function CreditCardRecommenderP1Page() {
  const offerwallQuiz = FINANCE_QUIZ_CONFIGS.creditCardRecommenderP1;
          ...
          <div className="flex flex-col items-center text-center space-y-8">
            ...
            <div className="border-l-4 border-[#0056b3] bg-gray-50 p-6 text-left w-full max-w-3xl rounded-r-md">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                preferences, we have additional alternatives available for your
                consideration.
              </p>
            </div>
