...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Find Your Best Credit Card Match | TopFinanzas US",
    description:
      "Discover the top US credit cards matched to your financial profile — cashback, no annual fee, 0% APR, and no credit check options compared.",
    images: [
...
export default function InvitCreditCardRecUSSeoOptimizedPage() {
  const offerwallQuiz = FINANCE_QUIZ_CONFIGS.creditCardRecommender;
