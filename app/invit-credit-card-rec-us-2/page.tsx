    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 md:py-12 max-w-4xl">
        <div className="flex flex-col items-center text-center space-y-8">
          {/* Hero Title */}
          <h1 className="text-3xl md:text-4xl font-bold text-[#17A2A2]">
          ...
          <div className="flex flex-col gap-3 w-full max-w-md mx-auto">
            <Link
              ...
              className="block w-full rounded-lg bg-[#17A2A2] hover:bg-[#138F8F] text-white py-3 px-6 text-base font-semibold transition-colors text-center"
            >
          ...
          {/* Well Done Section */}
          <div className="border-l-4 border-[#17A2A2] bg-gray-50 p-6 text-left w-full max-w-3xl rounded-r-md">
            <h3 className="text-2xl font-semibold text-[#17A2A2] mb-3">
              Well Done
            </h3>
          ...
          <Link
            ...
            className="inline-flex items-center justify-center rounded-lg bg-[#17A2A2] hover:bg-[#138F8F] text-white py-3 px-8 text-base font-bold uppercase tracking-wide transition-colors"
          >
