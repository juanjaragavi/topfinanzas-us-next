  ...
  const ScratchCardPrompt = () => (
    ...
    >
      ...
      <div className="relative z-10">
        <p className="font-extrabold text-lg text-amber-900 drop-shadow-sm">
          Tap your goal below to scratch off Step 2!
        </p>
          ...
          >
            <motion.div variants={itemVariants}>
              <Button
                variant="3d-green"
                fullWidth
                onClick={() => handleNext("cash")}
                aria-label="Cashback rewards"
              >
                💰 Maximize Cashback
              </Button>
            </motion.div>
            <motion.div variants={itemVariants}>
              <Button
                variant="3d-green"
                fullWidth
                onClick={() => handleNext("travel")}
                aria-label="Travel rewards"
              >
            ...
            <motion.div variants={itemVariants}>
              <Button
                variant="3d-green"
                fullWidth
                onClick={() => handleNext("low_rate")}
                aria-label="Low interest rate"
              >
                📉 Keep Rates Low
              </Button>
            </motion.div>
