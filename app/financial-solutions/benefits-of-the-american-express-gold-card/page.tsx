...
import JobsOfferwall from "@/lib/offerwall-for-jobs";
import { JOBS_QUIZ_CONFIGS } from "@/lib/jobs-quiz-config";
...
export default function AmexGoldBenefitsPage() {
  const offerwallQuiz = JOBS_QUIZ_CONFIGS.amexGoldJobs;
  ...
  return (
    <>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose max-w-none text-gray-700">
                <p className="text-left text-lg text-gray-800 font-medium mb-8 leading-5">
                  ...
                  everyday purchases, and effectively earn points, this card
                  could be an excellent choice for you. Below, we explore its
                ...
                <ul className="space-y-2 mb-6 list-none pl-0">
                  <li className="flex items-start">
                    ...
                    <p>
                      ...
                      including takeout and delivery services, on up to $50,000
                      in purchases per year. After that, you earn 1X point.
                    </p>
                  </li>
                  <li className="flex items-start">
                    <div className="h-2 w-2 rounded-full bg-[#C8B56A] mt-2.5 mr-3 flex-shrink-0"></div>
                ...
                <p className="mb-6">
                  ...
                  becomes simple, helping you maximize purchases and redeem
                  points for travel, shopping, and more.
                </p>
                ...
                <ul className="space-y-2 mb-6 list-none pl-0">
                  <li className="flex items-start">
                    <div className="h-2 w-2 rounded-full bg-[#C8B56A] mt-2.5 mr-3 flex-shrink-0"></div>
                    <p>
                      <strong>$120 Uber Cash:</strong> By adding your card to
                      your Uber account, you'll receive $10 monthly for Uber
                      Eats orders or rides within the U.S.
                    </p>
                  </li>
                  <li className="flex items-start">
                    <div className="h-2 w-2 rounded-full bg-[#C8B56A] mt-2.5 mr-3 flex-shrink-0"></div>
                    <p>
                      <strong>$120 dining credits:</strong> Earn up to $10
                      monthly in credits when you pay with the card at Grubhub,
                      The Cheesecake Factory, Goldbelly, Wine.com, and Five
                      Guys. Enrollment required.
                    </p>
                  </li>
                  <li className="flex items-start">
                    <div className="h-2 w-2 rounded-full bg-[#C8B56A] mt-2.5 mr-3 flex-shrink-0"></div>
                    <p>
                      ...
                      semi-annually when dining at U.S. Resy restaurants or
                      making other eligible Resy purchases. This is perfect if
                      you enjoy elegant dinners or reservations at select
                      establishments.
                    </p>
                  </li>
                  <li className="flex items-start">
                ...
                <ul className="space-y-2 mb-6 list-none pl-0">
                  ...
                  <li className="flex items-start">
                    <div className="h-2 w-2 rounded-full bg-[#C8B56A] mt-2.5 mr-3 flex-shrink-0"></div>
                    <p>
                      <strong>Access to The Hotel Collection:</strong> Book two
                      or more nights at select hotels through AmexTravel.com and
                  ...
                  <li className="flex items-start">
                    <div className="h-2 w-2 rounded-full bg-[#C8B56A] mt-2.5 mr-3 flex-shrink-0"></div>
                    <p>
                      <strong>Car rental insurance:</strong> Protects your
                      rental vehicle when you pay with your card and decline
                      coverage at the rental company counter.
                    </p>
                  </li>
                </ul>
                <p className="mb-6">
                ...
                <ol className="space-y-2 my-8 list-none pl-0 counter-reset-list">
                  ...
                  <li className="flex items-start">
                    ...
                    <p>
                      <strong>Plan It®:</strong> Split large purchases into
                      fixed monthly payments with a pre-set fee, reducing the
                      pressure of paying everything at once.
                    </p>
                  </li>
                </ol>
                ...
                <ol className="space-y-2 my-8 list-none pl-0">
                  ...
                  <li className="flex items-start">
                    ...
                    <p>
                      Frequent travelers looking to efficiently accumulate
                      points for flights and hotels.
                    </p>
                  </li>
                  <li className="flex items-start">
                    <div
                    ...
                    <p>
                      Food enthusiasts who want to enjoy exclusive dining
                      credits and premium culinary experiences.
                    </p>
                  </li>
                </ol>
                ...
                <p className="mb-6">
                  ...
                  offset the cost if fully utilized. If your spending habits
                  align with its key categories, this card could be the perfect
                  addition to your wallet.
                </p>
                <p className="mb-8">
                  If you're ready to maximize your purchases and enjoy
                  exceptional culinary and travel experiences, consider the
                  American Express® Gold Card as your next financial tool.
                </p>
              </div>
      ...
      <JobsOfferwall config={offerwallQuiz} />
