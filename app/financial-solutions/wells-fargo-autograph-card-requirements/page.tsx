        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-[#6C2156]">
            ...
            <div className="flex flex-col items-center justify-center mb-8">
              ...
              >
                <Button className="w-full md:w-auto px-12 py-6 text-xl bg-[#6C2156] hover:bg-[#5a1b47] text-white font-bold rounded-full shadow-md transition-all duration-200">
