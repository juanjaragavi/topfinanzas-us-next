        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-[#07296B]">
            ...
            <div className="flex flex-col items-center justify-center mb-8">
              ...
              >
                <Button className="w-full md:w-auto px-12 py-6 text-xl bg-[#07296B] hover:bg-[#051e4d] text-white font-bold rounded-full shadow-md transition-all duration-200">
