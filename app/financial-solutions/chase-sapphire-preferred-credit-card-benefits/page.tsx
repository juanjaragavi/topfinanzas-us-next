          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-left text-gray-800 mb-4 text-md leading-5 font-light">
                ...
                collision damage waiver: Save on costly rental insurance fees
              ...
              <p className="text-left text-gray-800 mb-4 text-md leading-5 font-light">
                ...
                for added flexibility and value.
              </p>
              ...
              <p className="text-left text-gray-800 mb-4 text-md leading-5 font-light">
                ...
                experiences. Its robust sign-up bonus, flexible reward system,
                and travel protections make it a top pick in its category.
              </p>
