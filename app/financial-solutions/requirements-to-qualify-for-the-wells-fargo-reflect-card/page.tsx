      ...
      <article className="bg-white py-8 md:py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-700 text-lg mb-4">
              If you meet the requirements, applying for the Wells Fargo Reflect®
            ...
            <div className="flex justify-center mb-6">
              ...
              >
                <Button className="w-full px-10 py-6 text-xl bg-[#98c5e9] hover:bg-[#8bb4d4] text-white font-bold rounded-full shadow-md transition-all duration-200">
